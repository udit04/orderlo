        ...
        <SignupContainer>
            <StackHeader><BackIcon onClick={()=>{closeSignup(false)}} height={16} width={16}/>Already a member ? </StackHeader>
            {
                ...
                <LoginCard className='signupCard'> 
                    ...
                    <TextInputWrapper>
                        <TextInput required placeholder='Restaurant' type='text' name='first_name' onChange={(e)=>{setFirstName(e.target.value)}} value={first_name}  type="text"/>
                        <img src={require('../../../public/static/name.png')}/>
                    </TextInputWrapper>
                    <TextInputWrapper >
                        <TextInput required id='last_name' name='Username' type='text' placeholder='Last name' onChange={(e)=>{setLastName(e.target.value)}} value={last_name} type="text"/>
                        <img src={require('../../../public/static/name.png')}/>
                    </TextInputWrapper>
                    <TextInputWrapper>
                    ...
                    <TextInputWrapper>
                        <TextInput required id='pin' name='pin' placeholder='password'  type={pinType} onChange={(e)=>{setPin(e.target.value.length<=10?e.target.value:pin)}} value={pin} />
